...
<section> 
    ...
    <div class="faq_item_wrap_row">
        <div class="faq_item_wrap_col">

            <div class="faq_item"> 
                <a href="#" class="faq_link"> 
                    <span>Как подобрать мощность стабилизатора?</span> 
                </a> 
                    <div class="faq_answ"> 
...
Vivamus sagittis nulla vitae erat vestibulum, tempor convallis risus tincidunt. Quisque ante nisi, viverra a nisi ac, ornare dapibus dolor. Maecenas efficitur lectus sapien, non bibendum nisl tincidunt sed. Nunc id iaculis felis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut eget lorem viverra, aliquam ipsum vel, volutpat ipsum. Vivamus suscipit ac nisl et hendrerit. Donec leo orci, feugiat at dolor nec, egestas malesuada ante. Curabitur laoreet dolor sodales, tincidunt enim nec, consectetur odio. Donec non faucibus turpis. Morbi gravida elementum suscipit. Morbi in est sodales, aliquet metus a, aliquet turpis.

Mauris sem ex, fermentum quis porta a, sagittis in tortor. Curabitur interdum mauris nisi, vitae iaculis lectus pharetra venenatis. Fusce at nisi a dui efficitur dapibus. Proin convallis, est et pellentesque dapibus, dolor augue ornare felis, tempor dapibus felis nulla ut justo. Sed augue justo, mollis vel tempus quis, consectetur eget leo. Integer sed ex venenatis, semper odio vitae, finibus enim. Curabitur elementum quam vel lectus tristique, et.</p> 
                </div> 
            </div> 
...
<section id="productsAndPrice" style="margin-bottom: 150px;"></section>